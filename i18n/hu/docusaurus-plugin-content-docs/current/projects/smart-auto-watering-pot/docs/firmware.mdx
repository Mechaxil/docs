...
A firmware egy <GlossaryTerm term="Development board of choice" /> panelen fut, <GlossaryTerm term="MicroPython" /> használatával.
Beolvassa a <GlossaryTerm term="Capacitive Soil Moisture Sensor" /> értékeit, a kalibrált küszöbök alapján eldönti, mikor kell öntözni, egy <GlossaryTerm term="MOSFET" /> segítségével, <GlossaryTerm term="PWM" /> használatával lágyan indítja a szelepet, és a beépített <GlossaryTerm term="RGB LED" />-del jelzi a rendszer állapotát.
...
Másold a `main.py` fájlt a <GlossaryTerm term="Development board of choice" /> panelre, például Thonny, rshell vagy mpremote segítségével, hogy induláskor automatikusan fusson.
...
1. Futtasd le a **Kalibráció** oldalon szereplő szkriptet, és jegyezd fel a száraz és nedves talajhoz tartozó <GlossaryTerm term="ADC" /> értékeket.
